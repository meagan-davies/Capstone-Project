...
class RealtimeEMGSystem:
    ...
    def start(self, log_folder: str = "logs"):
        """Start real-time classification with logging"""
        
        # Initialize logger
        logger = CSVLogger(folder=log_folder)
            ...
            while self.is_running:
                if self.processor.is_window_ready():
                    ...
                    if features is not None:
                        ...
                        # Log to CSV
                        logger.log(pred_label, class_name, confidence)
